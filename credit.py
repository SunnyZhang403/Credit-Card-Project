...
def updateacc(day, month): #updates balance numbers and day/month
...
def purchase(amount, day, month, country):
    ...
    elif all_three_different(last_country, last_country2, country) == True:
        disableaccount()
        return "error"
...
if __name__ == '__main__':
    ...
    pay_bill(5.5, 6, 3) #clear account for convenience (balance is zero)
